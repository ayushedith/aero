...
export function Architecture() {
  return (
    <section id="architecture" className="relative border-t-2 border-foreground">
          ...
          <div>
            ...
            <div className="mt-8 space-y-4">
              {PIPELINE.map((step, index) => (
                <div
                  key={step.title}
                  className="flex items-start gap-4 border-2 border-foreground bg-surface px-4 py-4 shadow-[6px_6px_0_0_#1a1a1a]"
                >
          ...
          <div className="border-2 border-foreground bg-surface px-6 py-6 shadow-[6px_6px_0_0_#1a1a1a]">
            ...
            <div className="mt-6 space-y-4">
              {PRINCIPLES.map((principle, index) => (
                <div
                  key={principle.title}
                  className={`border-2 border-foreground px-4 py-4 ${
                ...
                >
                  ...
                  <p className="text-xs text-foreground/70">{principle.desc}</p>
                </div>
              ))}
            </div>
          </div>
